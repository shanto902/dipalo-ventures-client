...
const FounderVideo = () => {
  ...
  return (
    <div className='flex w-full relative justify-center items-center py-10 flex-col gap-1 overflow-hidden'>
      <div className="text-center text-dipalo underline underline-offset-[10px] text-4xl font-bold">Founder Introduction Video</div>
      ...
      {showButton && (
        <div className={`absolute bottom-32 opacity-${buttonOpacity}`}>
          <button className='btn btn-outline btn-ghost text-white' onClick={handleToggleMute}>
            Click To Unmute
            <label className="swap">
              {muted ? (
                <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <path d="M3,9H7L12,4V20L7,15H3V9M16.59,12L14,9.41L15.41,8L18,10.59L20.59,8L22,9.41L19.41,12L22,14.59L20.59,16L18,13.41L15.41,16L14,14.59L16.59,12Z"/>
                </svg>
              ) : (
                <svg className="swap-on fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
