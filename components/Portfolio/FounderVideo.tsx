...
const FounderVideo = () => {
      ...
      return  <div className=' flex w-full justify-center items-center py-10  flex-col gap-10     '>
        ...
        <iframe  className=' rounded-xl' loading="lazy" width="1236" height="695" src="https://www.youtube.com/embed/IqbFkaLaII0" title="Dipalo Ventures Portfolio Companies" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
}
