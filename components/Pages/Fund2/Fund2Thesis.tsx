...
const Fund2Thesis = () => {
  return (
    <PaddingContainer>
      ...
      <PaddingContainer className="relative md:h-[450px] h-[500px] w-full bg-[url('../public/assets/fund-2/1.jpeg')]  bg-fixed bg-center bg-cover rounded-3xl overflow-hidden">
        <div className="absolute inset-0 bg-black bg-opacity-50 " />
        <div className="absolute inset-0 flex-col text-justify items-center justify-center mx-auto text-white max-w-3xl flex">
          <div className='p-5'>
            <AnimatedPara
              animationStyle="fade"
              className=" text-white text-center lg:text-2xl text-xl pb-5  "
            >
