...
const contactInfoText: TContactInfo[] = [
  ...
  },
  {
    mainText: 'Mail',
    subText:
      "Email (General): <a href='mailto:info@dipaloventures.com'>info@dipaloventures.com </a> <br/> Deals (Startups): <a href='mailto:deals@dipaloventures.com'>deals@dipaloventures.com</a>",
...
const ContactInfo = () => {
  return (
    <PaddingContainer className=" grid lg:grid-cols-3 md:grid-cols-2 justify-items-center grid-cols-1 gap-y-14 my-14 ">
