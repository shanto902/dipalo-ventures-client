...
const WhatWeDo = () => {
  return (
    <div className=" relative">
      <Image
        className="   md:w-96 w-56 bottom-0 -z-10 right-0 absolute"
      ...
      <PaddingContainer>
        <div className=" lg:-mt-56 md:m-0 md:mt-20 justify-start items-center gap-28 lg:inline-flex">
          <Image
          ...
          <div className="flex-col justify-start items-start gap-5 inline-flex md:py-72 py-40">
            <div>
